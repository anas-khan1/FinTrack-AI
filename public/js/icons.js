...
const Icons = {
    ...
    expenses: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>`,
    income: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>`,
    budgets: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>`,
    analytics: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>`,
...
// Category color dots instead of emojis
const CATEGORY_DOTS = {
...
const SOURCE_DOTS = {
    'Salary': '#22c55e', 'Freelance': '#8b5cf6', 'Investment': '#3b82f6',
    'Business': '#f59e0b', 'Gift': '#ec4899', 'Other': '#94a3b8'
};

function categoryDot(cat) {
    const c = CATEGORY_DOTS[cat] || '#94a3b8';
    return `<span class="color-dot" style="background:${c}"></span>`;
}

function sourceDot(src) {
    const c = SOURCE_DOTS[src] || '#94a3b8';
    return `<span class="color-dot" style="background:${c}"></span>`;
}

// Recommendation icon mapping (replaces emojis in AI advisor)
const REC_ICONS = {
